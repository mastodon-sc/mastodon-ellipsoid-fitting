...
public class FitEllipsoidTest
{
	...
	public void testMultipleEllipsoid()
	{
		...
		int numberOfFits = 1000;
		int successFulTests = runTests( 0.2d, 10, numberOfFits, numberOfTests );
		...
		assertTrue( disclaimer, successFulTests > numberOfTests * acceptedPercentageOfSuccessfulTests );

		numberOfFits = 100;
		successFulTests = runTests( 0.2d, 10, numberOfFits, numberOfTests );
